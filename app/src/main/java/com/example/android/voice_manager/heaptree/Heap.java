...
public class Heap<T> {
    ...
    private final String TAG = "vm:heap";
    ...
    public void printHeap() {
        ...
        for (int n = 0; n < size; n++) {
            i++;
            AlarmItem alarmItem = (AlarmItem)heap.get(n).element;
            sb.append(alarmItem.getTime()+" ");
            //System.out.print(""+ ((AlarmItem)heap[n].item).relativeV + "*");
            if (i % step == 0) {
                step *= 2;
                i = 0;
                sb.append("\n");
